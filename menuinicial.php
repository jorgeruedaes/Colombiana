...
require('Admin/php/principal.php');
...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <!-- Favicon-->
    <link rel="icon" href="Archivos/Escudos/<?php echo String_Get_Valores('favicon');?>" type="image/x-icon">
    ...
    <!-- Preloader Css -->
    <link href="Admin/plugins/material-design-preloader/md-preloader.css" rel="stylesheet" />
...
<body class="theme-blue">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="pages/usuarios/gestionar.php">
    ...
    <section>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; <?php echo String_Get_Valores('año');?><a href="javascript:void(0);"> <?php echo String_Get_Valores('copyright');?></a>.
            </div>
            <div class="version">
                <b>Version: </b><?php echo String_Get_Valores('version');?>
            </div>
        </div>
        <!-- #Footer -->
    </aside>
    ...
    <aside id="rightsidebar" class="right-sidebar">
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            <li role="presentation" class="active"><a href="#skins" data-toggle="tab">Colores</a>
            </li>
...
<!--<script src="plugins/editable-table/mindmup-editabletable.js"></script>-->    <!-- Bootstrap Colorpicker Js -->
